(function($) {
    ...
    CE_Global.animation = function(el, force, callback) {
    ...
    CE_Global.loadDependencies = function( dependencies, callback ) {
        "use strict";
        ...
        var newDeps = dependencies.map( function( dep ) {
            return -1 === CE_Global._loadedDependencies.indexOf( dep ) ? "undefined" == typeof CE_Global._inQueue[ dep ] ? dep : ( CE_Global._inQueue[ dep ].push( _callback ), !0 ) : !1
        } );
        ...
        if ( newDeps[ 0 ] !== !0 ) {
            ...
            var queue = newDeps.map( function( script ) {
                CE_Global._inQueue[ script ] = [ _callback ];
                return $.getCachedScript( script );
            } );

            var onLoad = function() {
                newDeps.map( function( loaded ) {
                    CE_Global._inQueue[ loaded ].forEach( function( callback ) {
                        callback()
                    } );
                    delete CE_Global._inQueue[ loaded ];
                    CE_Global._loadedDependencies.push( loaded )
                } );
            };
    ...
    CE_Global.horizontalScroll = function(){
